...
public class Result implements Serializable {
    ...
    private static final Integer CUSTOMIZED_MESSAGE_RESULT = 4;
    ...
    public static Result customizedMessageResult(Object data) {
        return new Result(CUSTOMIZED_MESSAGE_RESULT, data.toString(), null);
    }
